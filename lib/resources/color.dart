...
class AppColors {
  ...
  static const Color black = Color(0xFF3D3B41);
  ...
  static const Color pinkColor = Color.fromARGB(255, 168, 58, 241);

  static const Color blackTextColor1 = Color(0xFF3D3B41);
  static const Color grayTextColor3 = Color(0xFF909090);
  static const Color grayLineOpacity = Color.fromARGB(237, 172, 170, 170);
