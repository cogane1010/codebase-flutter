...
class _DetailProjectScreenState extends State<DetailProjectScreen> {
  ...
  buildContinueButton(BuildContext context, ProjectListViewModel vm) {
  ...
  buildCancelButton(BuildContext context, ProjectListViewModel vm) {
    return GestureDetector(
      onTap: () async {
        if (C_Approval_Request_Id != null) {
          confirmReturnAlertDialog(
              ...
              onPressed: () async {
                ...
                print("buildContinueButton: c_Project_Id   " +
                    C_Approval_Request_Id.toString());
                if (!isEmpty(C_Approval_Request_Id)) {
                  vm.approveOrRejectProjectAndTask(
                      vm.moduleName.toString(),
                      C_Approval_Request_Id.toString(),
                      false,
